...
Вопросы
 ...
 > предварительно подготовленный вокабуляр, из которого нейросеть будет составлять текст
 - где находится датасет для контроля и для теста?
 > в файлах val.json и test.json
 - как устроен экземпляр данных для обучения?
 > он состоит из guid, набора токенов, из которых состоит программа, самой программы и списка состояний сетки
...
Вопросы
 ...
 > исправлены в коммитах:
 > https://github.com/andresokol/gandrl_nps/commit/64c1d774479a9bb8048783d8dc08c1aae75647c3
 > https://github.com/andresokol/gandrl_nps/commit/abc7f71e890487bf711a50a4b7680db926a8fc45
 ...
 > на top10:
```
exact match: 14.909819639278558
full generalize: 21.20240480961924
semantic: 21.56312625250501
syntax: 100.0
```
